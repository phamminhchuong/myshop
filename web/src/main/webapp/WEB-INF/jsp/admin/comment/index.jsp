...
<div class="navbar bg-white breadcrumb-bar border-bottom">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="#">Chia sẻ</a>
                            </li>
	                                ...
	                                <div class="media chat-item">
	                                    ...
	                                    <div class="media-body">
	                                        <div class="chat-item-title">
	                                            ...
	                                            <span>${stdDatum }</span>
	                                            <span><a href="${pageContext.request.contextPath }/admin/comment/del/${id_blog}/${objFa.id_comment}" title='Xóa' class='badge badge-danger'><i class='fas fa-trash'></i></a></span>
	                                        </div>
	                                ...
	                                <c:forEach var="objSon" items="${LcmSon }">
	                                	<c:if test="${objFa.id_comment == objSon.id_parent  }">
		                                	<c:forEach items="${Luser }" var="objU">
			                                	...
			                                	<div style="margin-left: 62px" class="media chat-item">
			                                    <div class="media-left">
				                                     <div class="avatar-image" >
	                                            ...
	                                            <span>${stdDatume }</span>
	                                            <span><a href="${pageContext.request.contextPath }/admin/comment/del/${objSon.id_comment}" title='Xóa' class='badge badge-danger'><i class='fas fa-trash'></i></a></span>
